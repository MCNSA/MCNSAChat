...
@Command.CommandInfo(alias = "cmode", permission = "mode", usage = "<channel> <mode changes>", description = "changes the modes of a channel. LOCAL MUTE RAVE RANDOM LOUD BORING PERSIST")
