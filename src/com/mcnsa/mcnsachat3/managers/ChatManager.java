...
public class ChatManager {
	...
	public void info(ChatPlayer player, String line, String channel, boolean net, String sender) {
		...
		if (line.matches("<&[a-z0-9]{1}"+plugin.name+"[a-z0-9]{1,30}&?f?>") && plugin.getConfig().getString("console-listen-other-servers").startsWith("false") && plugin.getConfig().getString("console-hide-chat").startsWith("false")) {
			Bukkit.getConsoleSender().sendMessage(PluginUtil.color(line));
		}
	}
